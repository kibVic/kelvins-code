...
def preprocess_data(df):
    ...
    df[["sensor_value", "fire_lat", "fire_lon", "confidence"]] = scaler.fit_transform(
        df[["sensor_value", "fire_lat", "fire_lon", "confidence"]]
    )
...
def train_model_with_tuning(X_train, y_train):
    ...
    # Use GridSearchCV with 3-fold cross-validation and parallelization
